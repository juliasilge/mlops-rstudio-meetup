---
title: "Get started with MLOps and vetiver at the RStudio Enterprise Meetup"
...
<p class="text-center"><a class="btn btn-success btn-lg" target="_blank" href="https://youtu.be/oFQANK13-k4">{{< fa brands youtube >}} &ensp;Watch the recording</a></p>

## Slides

<p class="text-center"><a class="btn btn-success btn-lg" target="_blank" href="slides/">{{< fa arrow-up-right-from-square >}} &ensp;View slides in new window</a> <a class="btn btn-success btn-lg" target="_blank" href="slides/slides.pdf" role="button">{{< fa file-pdf >}} &ensp;Download PDF of all slides</a></p>
